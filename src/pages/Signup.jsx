...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const userData = userType === 'shopkeeper' 
        ? { ...formData, ...shopData }
        : formData
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md rounded-xl border bg-base-100 p-10 shadow-lg" style={{
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2" style={{color: '#ffffff'}}>Create Account</h1>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-medium" style={{color: '#FFD700'}}>Register As</span>
            </label>
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-medium" style={{color: '#FFD700'}}>Name</span>
            </label>
            <input 
              type="text" 
              name="name"
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-medium" style={{color: '#FFD700'}}>Phone (Optional)</span>
            </label>
            <input 
              type="tel" 
              name="phone"
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-medium" style={{color: '#FFD700'}}>Address (Optional)</span>
            </label>
            <textarea 
              name="address"
              value={formData.address}
              onChange={handleInputChange}
              className="textarea textarea-bordered w-full transition-all duration-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
          ...
          {userType === 'shopkeeper' && (
            <>
              <div className="divider text-yellow-400">Shop Information</div>
              
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium" style={{color: '#FFD700'}}>Shop Name</span>
                </label>
                <input 
                  type="text" 
                  name="shopName"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium" style={{color: '#FFD700'}}>Shop Address</span>
                </label>
                <textarea 
                  name="shopAddress"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium" style={{color: '#FFD700'}}>Shop Details (Optional)</span>
                </label>
                <textarea 
                  name="shopDetails"
                  value={shopData.shopDetails}
                  onChange={handleShopDataChange}
                  className="textarea textarea-bordered w-full transition-all duration-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
        ...
        <div className="text-center mt-8 pt-6 border-t border-gray-200">
          <p className="text-sm text-gray-600">
            Already have an account? <Link to="/login" className="link link-primary font-medium hover:underline">Login</Link>
          </p>
        </div>
      </div>
    </div>
